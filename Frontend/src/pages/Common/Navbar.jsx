      ...
      <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50
        ...
        <div className='p-4'>
          ...
          <nav className='space-y-4'>
            <Link to="#" onClick={toggleNavDrawer} className='block text-gray-700 hover:text-black uppercase cursor-pointer'>Men</Link>
            <Link to="#" onClick={toggleNavDrawer} className='block text-gray-700 hover:text-black uppercase cursor-pointer'>Women</Link>
            <Link to="#" onClick={toggleNavDrawer} className='block text-gray-700 hover:text-black uppercase cursor-pointer'>Top Wear</Link>
            <Link to="#" onClick={toggleNavDrawer} className='block text-gray-700 hover:text-black uppercase cursor-pointer'>Bottom wear</Link>
          </nav>
        </div>
